...
JNIEXPORT jchar JNICALL Java_com_blainmaguire_colorassist_MainActivity_RGB2Hue(JNIEnv*, jobject, jchar red, jchar green, jchar blue) {

    return rgb2HSV(red,green,blue)[0];

}

JNIEXPORT void JNICALL Java_com_blainmaguire_colorassist_MainActivity_ShowColor(JNIEnv*, jobject, jlong addrRgba, jchar red, jchar green, jchar blue, jint size, jboolean invert) {
...
JNIEXPORT jcharArray JNICALL Java_com_blainmaguire_colorassist_MainActivity_ColorPicker(JNIEnv *env, jclass cls, jlong addrRgba) {
...
JNIEXPORT void JNICALL Java_com_blainmaguire_colorassist_MainActivity_Channels(JNIEnv, jobject, jlong addrRgba, jboolean red, jboolean green, jboolean blue, jint size, jboolean invert) {
